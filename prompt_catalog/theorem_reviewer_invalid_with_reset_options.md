...
- Situation: Theorem-stating reviewer on an invalid attempt with a worker crisis report and supervisor-approved reset checkpoints.
...
--- WORKER HANDOFF ---
{
  "summary": "Fundamental gap encountered.",
  "status": "CRISIS"
}
...
NOTE: The worker has hit 5 consecutive INVALID attempts on this in-flight cycle.
...
--- AVAILABLE VALID RESET CHECKPOINTS ---
...
- `initial`: initial setup commit
- `cycle-3`: cycle 3 | reviewer/final | theorem_stating | PROGRESS
